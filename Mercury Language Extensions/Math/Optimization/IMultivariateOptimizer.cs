...
{
    /// <summary>
    /// This interface represents an optimization algorithm for <see cref="IMultivariateFunction">scalar objective functions</see>.
    ...
    /// </summary>
    public interface IMultivariateOptimizer: IBaseMultivariateOptimizer<IMultivariateFunction>
    {
    }
}
