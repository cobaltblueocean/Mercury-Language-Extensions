...
namespace Mercury.Language.Exceptions
{
    ...
    public class FunctionEvaluationException: MathArithmeticException
    {
        ...
        public FunctionEvaluationException(double argument): base(String.Format(LocalizedResources.Instance().EVALUATION_FAILED_FOR_ARGUMENT, argument))
        {
        ...
        /// </summary>
        /// <param name="argument">the failing function argument</param>
        public FunctionEvaluationException(double[] argument): base(String.Format(LocalizedResources.Instance().EVALUATION_FAILED_FOR_ARGUMENT, argument.ToString()))
        {
        ...
        public FunctionEvaluationException(double argument, System.Exception cause): base(String.Format(LocalizedResources.Instance().EVALUATION_FAILED_FOR_ARGUMENT, argument), cause)
        {
            this.argument = new double[] { argument };
        }
        ...
        /// <param name="argument">the failing function argument</param>
        /// <param name="cause">the exception or error that caused this exception to be thrown</param>
        public FunctionEvaluationException(double[] argument, System.Exception cause) : base(String.Format(LocalizedResources.Instance().EVALUATION_FAILED_FOR_ARGUMENT, argument.ToString()), cause)
        {
            this.argument = (double[])argument.Clone();
        }
