...
{
    /// <summary>This interface specifies how to check if an {@link MultivariateRealOptimizer optimization
    ...
    /// {@link SimpleScalarValueChecker} and {@link SimpleRealPointChecker}d The first
    ...
    /// 
    /// @version $Revision: 799857 $ $Date: 2009-08-01 15:07:12 +0200 (samd 01 août 2009) $
    /// @since 2.0
    /// </summary>

    public interface IRealConvergenceChecker
    {
