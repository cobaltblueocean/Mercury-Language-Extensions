...
namespace Mercury.Language.Math.Optimization
{
    ...
    /// @since 2.0
    /// </summary>
    public class MultiStartDifferentiableMultivariateRealOptimizer : IDifferentiableMultivariateRealOptimizer
    {

        /// <summary>IUnderlying classical optimizerd */
        private IDifferentiableMultivariateRealOptimizer _optimizer;
        ...
        /// <summary>Number of gradient evaluations already performed for all startsd */
        private int _totalGradientEvaluations;
        ...
        public MultiStartDifferentiableMultivariateRealOptimizer(IDifferentiableMultivariateRealOptimizer optimizer, int starts, RandomVectorGenerator generator)
        {
            this._optimizer = optimizer;
            this._totalIterations = 0;
            this._totalEvaluations = 0;
            this._totalGradientEvaluations = 0;
            this._starts = starts;
        ...
        /// #Optimize(IDifferentiableMultivariateRealFunction, GoalType, double[])
        /// optimize}.
        /// <p>The optimizer stores all the optima found during a set of
        /// restartsd The {@link #Optimize(IDifferentiableMultivariateRealFunction,
        /// GoalType, double[]) optimize} method returns the best point onlyd This
        ...
        /// elements will be null if the {@link #Optimize(IDifferentiableMultivariateRealFunction,
        ...
        /// <exception cref="InvalidOperationException">if {@link #Optimize(IDifferentiableMultivariateRealFunction, </exception>
        ...
        {
            get { return _totalGradientEvaluations; }
        }
        ...
        public RealPointValuePair Optimize(IDifferentiableMultivariateRealFunction f, GoalType goalType, double[] startPoint)
        {
            ...
            for (int i = 0; i < _starts; ++i)
            {
                ...
                _totalGradientEvaluations += _optimizer.GradientEvaluations;
