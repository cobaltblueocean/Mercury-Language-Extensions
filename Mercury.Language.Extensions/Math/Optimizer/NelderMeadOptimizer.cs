...
namespace Mercury.Language.Math.Optimizer
{
    public class NelderMeadOptimizer : BaseMultivariateMultiStartOptimizer<IMultivariateRealFunction>, IMultivariateOptimizer
    {
        ...
        #region Constructor
        public NelderMeadOptimizer() : base(new DefaultOptimizer() { ReflectionCoefficient = 1.0, ExpansionCoefficient = 2.0, ContractionCoefficient = 0.5, ShrinkageCoefficient = 0.5 }, 1, new System.Random())
        {
            this.rho = 1.0;
            this.khi = 2.0;
            this.gamma = 0.5;
        ...
        public NelderMeadOptimizer(double rho, double khi, double gamma, double sigma) : base(new DefaultOptimizer() { ReflectionCoefficient = rho, ExpansionCoefficient = khi, ContractionCoefficient = gamma, ShrinkageCoefficient = sigma }, 1, new System.Random())
        {
            this.rho = rho;
            this.khi = khi;
            this.gamma = gamma;
