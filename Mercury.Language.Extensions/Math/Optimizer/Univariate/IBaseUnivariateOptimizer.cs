...
namespace Mercury.Language.Math.Optimizer.Univariate
{
    ...
    public interface IBaseUnivariateOptimizer<FUNC> : IBaseOptimizer<double> where FUNC : IUnivariateRealFunction
    {
        /// <summary>
        ...
        double Optimize(FUNC f, GoalType goalType, double min, double max);
        ...
        double Optimize(FUNC f, GoalType goalType, double min, double max, double startValue);
    }
}
